/*IMP Q:- Given two vector arr1[] and arr2[] of size m and n sorted in increasing order. Merge the two arrays into a single 
           sorted array of size m+n.*/
...
int main() {
 ...
 while(i < m ) {
    // arr2 was exhausted and we still got element left in arr1
    result[k] = arr1[i];
    i++;
    k++;
 }
